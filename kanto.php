...
// 各地方のデータを配列で定義
$regions = [
  'Tokyo'       => ['name' => '東京都',    'top' => '65%', 'left' => '43%'],
  'Kanagawa'    => ['name' => '神奈川県',  'top' => '74%', 'left' => '40%'],
  'Chiba'       => ['name' => '千葉県',    'top' => '68%', 'left' => '80%'],
  'Saitama'     => ['name' => '埼玉県',    'top' => '50%', 'left' => '38%'],
  'Gunma'       => ['name' => '群馬県',    'top' => '23%', 'left' => '25%'],
  'Tochigi'     => ['name' => '栃木県',    'top' => '15%', 'left' => '60%'],
  'Ibaraki'     => ['name' => '茨城県',    'top' => '40%', 'left' => '80%']
];
?>
<!DOCTYPE html>
<html lang="ja">
...
<body>
  ...
  <div class="map-container">
    <img src="img/kanto.png" alt="関東地方">
