...
// 各地方のデータを配列で定義
$regions = [
  'Kagawa'     => ['name' => '香川県',    'top' => '8%', 'left' => '75%'],
  'Tokushima'  => ['name' => '徳島県',    'top' => '23%', 'left' => '80%'],
  'Ehime'      => ['name' => '愛媛県',    'top' => '28%', 'left' => '35%'],
  'Kouti'      => ['name' => '高知県',    'top' => '48%', 'left' => '50%']
];
?>
<!DOCTYPE html>
<html lang="ja">
...
<body>
  ...
  <div class="map-container">
    <img src="img/shikoku.png" alt="四国地方">
