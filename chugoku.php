...
// 各地方のデータを配列で定義
$regions = [
  'Tottori'    => ['name' => '鳥取県',    'top' => '35%', 'left' => '80%'],
  'Shimane'    => ['name' => '島根県',    'top' => '42%', 'left' => '50%'],
  'Okayama'    => ['name' => '岡山県',    'top' => '50%', 'left' => '80%'],
  'Hiroshima'  => ['name' => '広島県',    'top' => '55%', 'left' => '55%'],
  'Yamaguti'   => ['name' => '山口県',    'top' => '65%', 'left' => '23%']
];
?>
<!DOCTYPE html>
<html lang="ja">
...
<body>
  ...
  <div class="map-container">
    <img src="img/chugoku.png" alt="中国地方">
