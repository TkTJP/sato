...
// 各地方のデータを配列で定義
$regions = [
  'Shiga'    => ['name' => '滋賀県',    'top' => '23%', 'left' => '74%'],
  'Kyoto'    => ['name' => '京都府',    'top' => '20%', 'left' => '48%'],
  'Osaka'    => ['name' => '大阪府',    'top' => '49%', 'left' => '49%'],
  'hyogo'    => ['name' => '兵庫県',    'top' => '27%', 'left' => '20%'],
  'Nara'     => ['name' => '奈良県',    'top' => '55%', 'left' => '63%'],
  'Wakayama' => ['name' => '和歌山県',  'top' => '74%', 'left' => '45%'],
  'Mie'      => ['name' => '三重県',    'top' => '50%', 'left' => '80%']
];
?>
<!DOCTYPE html>
<html lang="ja">
...
<body>
  ...
  <div class="map-container">
    <img src="img/kinki.png" alt="近畿地方">
