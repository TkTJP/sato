...
// 各地方のデータを配列で定義
$regions = [
  'Fukuoka'    => ['name' => '福岡',    'top' => '15%', 'left' => '60%'],
  'Oita'       => ['name' => '大分',    'top' => '23%', 'left' => '80%'],
  'Saga'       => ['name' => '佐賀',    'top' => '25%', 'left' => '45%'],
  'Nagasaki'   => ['name' => '長崎',    'top' => '27%', 'left' => '36%'],
  'Kumamoto'   => ['name' => '熊本',    'top' => '45%', 'left' => '63%'],
  'Miyazaki'   => ['name' => '宮崎',    'top' => '50%', 'left' => '80%'],
  'Kagosima'   => ['name' => '鹿児島',  'top' => '74%', 'left' => '62%']
];
?>
<!DOCTYPE html>
<html lang="ja">
...
<body>
  ...
  <div class="map-container">
    ...
    onclick="location.href='<?= $region['file'] ?>'">
    ●
</div>
