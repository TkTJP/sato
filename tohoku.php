...
// 各地方のデータを配列で定義
$regions = [
  'Aomori'    => ['name' => '青森県',    'top' => '17%', 'left' => '55%'],
  'Iwate'     => ['name' => '岩手県',    'top' => '40%', 'left' => '65%'],
  'Miyagi'    => ['name' => '宮城県',    'top' => '60%', 'left' => '60%'],
  'Akita'     => ['name' => '秋田県',    'top' => '40%', 'left' => '47%'],
  'Yamagata'  => ['name' => '山形県',    'top' => '60%', 'left' => '45%'],
  'Fukushima' => ['name' => '福島県',    'top' => '85%', 'left' => '47%']
];
?>
<!DOCTYPE html>
<html lang="ja">
...
<body>
  ...
  <div class="map-container">
    <img src="img/tohoku.png" alt="九州地方">
