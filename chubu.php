...
// 各地方のデータを配列で定義
$regions = [
  'Niigata'    => ['name' => '新潟県',    'top' => '23%', 'left' => '80%'],
  'Toyama'     => ['name' => '富山県',    'top' => '48%', 'left' => '45%'],
  'Ishikawa'   => ['name' => '石川県',    'top' => '30%', 'left' => '37%'],
  'Fukui'      => ['name' => '福井県',    'top' => '63%', 'left' => '26%'],
  'Yamanashi'  => ['name' => '山梨県',    'top' => '72%', 'left' => '72%'],
  'Nagano'     => ['name' => '長野県',    'top' => '55%', 'left' => '60%'],
  'Gifu'       => ['name' => '岐阜県',    'top' => '60%', 'left' => '42%'],
  'Shizuoka'   => ['name' => '静岡県',    'top' => '85%', 'left' => '65%'],
  'Aiti'       => ['name' => '愛知県',    'top' => '85%', 'left' => '42%']
];
?>
<!DOCTYPE html>
<html lang="ja">
...
<body>
  ...
  <div class="map-container">
    <img src="img/chubu.png" alt="中部地方">
